...
void find (Student students[], int &n) {
    int key;
    bool found = false;
    ...
    if (n == 0) {
        ...
        std::cout <<"Enter Roll No to find a student : ";
        std::cin >>key;
...
int main () {
    ...
    do {
        ...
        std::cout <<"[3].Insert deatils at position\n";
        ...
        std::cout <<"[9].Count Students\n";
        std::cout <<"[10].Search with Roll No\n";
        std::cout <<"[11].Exit\n";
